...
//  
//
//  Created by Adam Share on 8/15/20.
//
...
//final class RxChannel: ObservableType {
//    
//}

public final class WebSocketTimeHandler: ChannelInboundHandler {
    ...
    private func sendTime(context: ChannelHandlerContext) {
        ...
        let buffer = context.channel.allocator.buffer(string: "\(theTime)")
