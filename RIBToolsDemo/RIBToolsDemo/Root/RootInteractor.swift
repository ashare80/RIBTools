...
final class RootInteractor: PresentableInteractor<RootPresentable>, RootInteractable, RootPresentableListener, RootActionableItem, UrlHandler {
    ...
    private let webSocketDebugHostWorker: Worker?

    // TODO: Add additional dependencies to constructor. Do not perform any logic
    // in constructor.
    init(presenter: RootPresentable, webSocketDebugHostWorker: Worker?) {
        self.webSocketDebugHostWorker = webSocketDebugHostWorker
    ...
    override func didBecomeActive() {
        ...
        webSocketDebugHostWorker?.start(self)
    }
